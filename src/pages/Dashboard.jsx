...
// Helper Component for Navigation Bar
const NavButton = ({ icon, label, active, onClick }) => (
    <button
        ...
        style={{
            background: 'none',
            border: 'none',
            color: active ? '#FFD700' : 'white', // Active tab is gold
            cursor: 'pointer',
            minWidth: '60px',
        }}
    >
            ...
            >
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <img 
                            src="https://placehold.co/30x30/006400/FFD700?text=A" 
                            alt="ASA Logo" 
                            style={{ 
                                height: '30px', 
                                width: '30px', 
                    ...
                    <div style={{ fontSize: '0.7rem', fontWeight: 'normal', opacity: 0.8, textAlign: 'right' }}>
                        User: {userId ? auth.currentUser?.email || userId.substring(0, 8) + '...' : 'Guest'}
                        <button 
                            onClick={handleLogout}
                            style={{ background: "none", border: "none", color: "#FFD700", cursor: "pointer", marginLeft: '10px' }}
                        >
                            {userId ? 'Logout' : 'Login'}
                        </button>
                    </div>
                ...
                {showComments && (
                    <div
                        style={{
                            position: "absolute",
                            bottom: 80, // Adjusted to sit just above the nav bar
                            left: 0,
                            width: "100%",
                            height: "50%", 
        ...
        <div style={{ 
            ...
            >
                ...
                {chatMessages.length === 0 ? (
                    <div style={{ opacity: 0.7, textAlign: 'center', marginTop: '20px' }}>Start the global conversation!</div>
                ) : (
                    chatMessages.map(msg => (
                        <div key={msg.id} style={{
                            ...
                            <div style={{
                                ...
                                padding: '10px 15px',
                                borderRadius: '15px',
                                background: msg.userId === userId ? '#006400' : '#444',
                                color: 'white',
                                boxShadow: '0 2px 5px rgba(0,0,0,0.2)'
                            }}>
                                <div style={{ fontWeight: 'bold', fontSize: '0.8rem', opacity: 0.9 }}>
                                    {msg.userId === userId ? 'You' : (msg.userId?.substring(0, 8) + '...')}
                                </div>
                                <div style={{ wordBreak: 'break-word', paddingTop: '4px' }}>{msg.text}</div>
            ...
            <div style={{ display: "flex", gap: "10px", padding: '10px 0', borderTop: '1px solid #333' }}>
                <input
                    ...
                    placeholder={userId ? "Type a global message..." : "Sign in to join the chat..."}
                    disabled={!userId}
                    style={{
                        flex: 1,
                        padding: "12px",
        ...
        >
            ...
            >
                ...
                <div style={{
                    ...
                    <span style={{ fontWeight: 'bold' }}>{userId ? 'Sign Out' : 'Sign In'}</span>
                </div>
            </nav>
